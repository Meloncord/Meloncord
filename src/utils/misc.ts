...
import { EquicordDevsById, MeloncordDevsById, VencordDevsById } from "./constants";
...
export const isMeloncordPluginDev = (id: string) => Object.hasOwn(MeloncordDevsById, id);
