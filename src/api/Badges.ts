...
export function _getBadges(args: BadgeUserArgs) {
    ...
    const meloncordDonorBadges = (Plugins.BadgeAPI as unknown as typeof import("../plugins/_api/badges").default).getMeloncordDonorBadges(args.userId);
    if (donorBadges) badges.unshift(...donorBadges);
    if (equicordDonorBadges) badges.unshift(...equicordDonorBadges);
    if (meloncordDonorBadges) badges.unshift(...meloncordDonorBadges);
