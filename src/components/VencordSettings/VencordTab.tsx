...
const SHIGGY_DONATE_IMAGE = "https://i.imgur.com/aiGIuTp.png";
...
function EquicordSettings() {
    ...
    return (
        <SettingsTab title="Meloncord Settings">
            ...
            <div>
                ...
                <div className={cl("card-buttons")}>
                    ...
                    <Button
                        ...
                        onClick={() => {
                            VencordNative.native.openExternal(
                                "https://github.com/sponsors/Melon-sodas",
                            );
                        }}
                    >
                        Donate
...
export default wrapTab(EquicordSettings, "MelonCord Settings");
