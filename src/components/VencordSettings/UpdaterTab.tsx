...
function Updater() {
    ...
    return (
        <SettingsTab title="Meloncord Updater">
            <Forms.FormTitle tag="h5">Updater Settings</Forms.FormTitle>
            <Switch
                value={settings.autoUpdate}
                onChange={(v: boolean) => settings.autoUpdate = v}
                note="Automatically update Meloncord without confirmation prompt"
            >
            ...
            <Switch
                ...
                note="Shows a notification when Meloncord automatically updates"
